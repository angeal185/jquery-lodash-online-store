...
cartItemTpl = _.template('<tr><td>{{title}}</td><td>{{id}}</td><td><a href="/category/{{category}}">{{category}}</a></td><td>{{price}}</td><td>{{stat}}</td><td><a href="/{{domain}}item/{{title}}">view</a></td><td><a target="_blank" href="{{link}}">Buy</a></td><td><button type="button" id="{{id}}" class="btn cartDel">Remove</button></td></tr>'),
